...
sockeye.length.km <- 609.6 / 1000000
total_obs <- n_obs_sb + n_obs_lakes
dist <- total_obs * sockeye.length.km # =7862 km

```

If each of the observations in our data set were an average sized sockeye salmon (~2 ft), they would stretch `r dist` km end to end from Seattle to Tokyo!
...
rm(nps.meta.1,nps.meta.2,nps.names.sb,nps.names.missing,nps.names.lakes)
```
