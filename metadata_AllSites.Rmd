...
NOTE: these metadata have been moved into the respective data cleaning sheets so that site names or other info as needed can be linked to data files. THIS Is NOT CURRENT METADATA.
...
# STOPPED HERE, KEEP FIXING METADATA IN DATA PREP SCRIPTS AND COMBINE HERE SO CAN BE BROUGHT INTO AKSSF, COMBINED THERE, EXPORTED TO GIS AND EXAMINED FOR LOCATION ACCURACY. NOTE SOME SITES MAY BE OUTSIDE BB - E.G. NPS.
