...
Krista Bartz and Paul Gabriel provided data from 18 streams and 10 lakes. Three of the lake locations were lakeshores and the other seven were depth arrays in the lake centers.   
...
```{r nps}
nps.md <- read_rds("output/nps_metadata.rds")
nps.sum <- read_rds("output/nps_data_summ.rds")
nps.dat <- left_join(nps.md, nps.sum)
