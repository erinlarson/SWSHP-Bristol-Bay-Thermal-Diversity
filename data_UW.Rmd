...
- Resolve Lynx Creek site names conflicts
- Resolve multiple AKOATS_ID conflicts for sites UW-FRI_NerkaBear_Temps, UW_FRI_WR_PfiferTemps, and UW_FRI_WR_SilverSalmon_Temps
- See notes column in UW metadata for suggestions on how to resolve these conflicts

```{r}
# read in UW metadata provided by J Carter on 11/13/20
uw.metadata <- read_excel("data/Jackie Carter UW/uw sites_JC_rss.xlsx")

## Lynx creek naming conflicts
...
## UW-FRI_NerkaBear_Temps conflict
