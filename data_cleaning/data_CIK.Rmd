...
Just site names and lat/long right now. Sue didn't provide lat/longs in her metadata file so need to try and match names in AKOATS. Sue emailed lat/long for Ben Courtney Creek and Roadhouse Creek lat/long from Dan.
...
(Currently from Ben and not updated or run, may develop scripts for sub-daily data and run on everything later.)
