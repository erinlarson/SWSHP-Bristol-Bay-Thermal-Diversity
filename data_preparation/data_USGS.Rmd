...
# RS code for getting all sites in BB and CI
...
usgs_md <- bind_cols(usgs_sa, as.data.frame(st_coordinates(usgs_sa))) %>% 
  st_drop_geometry() %>% 
...
usgs_dat %>% 
  distinct(X_00010_00001_cd)

usgs_dat %>% 
  distinct(X_00010_00002_cd)
