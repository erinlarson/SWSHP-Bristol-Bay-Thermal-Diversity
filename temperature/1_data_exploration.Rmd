...
autoplot(pc2, data = mets11_scwd, frame.type='norm', fill=NULL, frame.colour = "Name", labels = TRUE, loadings.label = TRUE,loadings.label.colour = "black", loadings.label.repel = TRUE, loadings.colour = "black") +
  theme_bw()
