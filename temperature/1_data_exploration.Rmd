...
ggplot(data=BB_mets_summary, aes(x=as.Date(MA7d_DMT_jd, origin="1970-01-01"), fill=as.factor(Year)))+geom_histogram( binwidth=1, color="black")+theme_bw()+xlab("Month")+ylab("MWMT Count by Day")+ scale_fill_brewer(type="seq",palette="YlOrRd", name="Year")
