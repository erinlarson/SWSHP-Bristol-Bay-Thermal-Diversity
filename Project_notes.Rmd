...
* University of Washington. Jackie Carter has provided metadata and data for streams through 2020. The data are provided as two sets - through 2017 and 2018-2020. 
* NPS. Krista Bartz plans to send all data from their Southwest Monitoring Network. (Note that data through 2017 was also archived on KNB, but don't bother because we'll be getting all years for all sites from Krista.)
