...
* NPS. Krista Bartz has sent all data from their Southwest Monitoring Network, including lake arrays. 
* UWFWS. Meg has shared all FWS data for the State. We will be using data from Togiak refuge for this project. We are also waiting on some lake data that is being reviewed by FWS staff.
