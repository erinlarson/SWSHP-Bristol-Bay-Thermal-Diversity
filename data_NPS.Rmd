...
## one file read-in & format example
...
# the loop reads in only the first file...?!
unique(nps.lakes$SiteID)

# why is it not iterating over all 7 file paths in "all_paths" list?
